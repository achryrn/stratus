...
const defaultWarningTexts: FloorpHubWarningTexts = {
  message:
    "Stratus-specific settings such as the panel sidebar, Workspaces, and mouse gestures are managed in Stratus Hub.",
  buttonLabel: "Open Stratus Hub",
};
...
function addFloorpHubCategory(): void {
  ...
  hubButton.textContent = "Stratus Hub";
...
const defaultStartWarningTexts: FloorpHubWarningTexts = {
  message:
    'To change the "Home" setting, disable Stratus Start from Stratus Hub (about:hub#/features/design).',
  buttonLabel: "Open Stratus Hub — Design",
};
