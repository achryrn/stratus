...
APPLICATIONS = OrderedDict([
    ...
    ("GeckoView/Noraneko for Android Artifact Mode", "mobile_android_artifact_mode"),
    ("GeckoView/Noraneko for Android", "mobile_android"),
])
...
class Bootstrapper:
    ...
    def bootstrap(self, settings):
        ...
        # Offer to configure Git, if the current checkout or repo type is Git.
            ...
            if not self.instance.no_interactive:
                # No need to configure git-cinnabar because of noraneko repo cannot be merged to mozilla-central by compatibility.
                should_configure_git = False
            else:
